...
// bil.insert.alwaysOn(cf.canvasBorder(hsl(240),1));
//-------------------
...
slide.addH2("This is H3",3,0,25,85,240);
slide.addH2("This is H4",4,0,50,85,180);
slide.addH2("This is H5",5,0,75,85,300);
