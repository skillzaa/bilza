import IncrementTimeBased from "../../../../src/BaseComponent/animation/filters/incrementTimeBased.js"

test('setup', () => {
    let inc = new IncrementTimeBased (0,10,1,100);
    expect(inc).toBeDefined();
});

test('update(0) = null not included', () => {
    let inc = new IncrementTimeBased (0,10,0,100);
...
test('from-0,to-10,startVal-0,endVal-1000', () => {
    let inc = new IncrementTimeBased (0,10,0,1000);
    inc.update(0); //msDelta is in ms
    expect(inc.value()).toBeNull();
});
test('from-0,to-10,startVal-0,endVal-1000', () => {
...
test('from-0,to-10,startVal = -500,endVal =500', () => {
    let inc = new IncrementTimeBased (0,10,-500,500);
    inc.update(5000); //msDelta is in ms
