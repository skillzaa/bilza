import Range from "../../../../src/BaseComponent/animation/filters/range.js"

test('setup', () => {
    let inc = new Range (0,10,1,100);
    expect(inc).toBeDefined();
});

test('update(0) = null not included', () => {
    let inc = new Range (0,10,0,100);
...
test('from-0,to-10,startVal = -500,endVal =500', () => {
    let inc = new Range (0,10,-500,500);
    inc.update(5000); //msDelta is in ms
