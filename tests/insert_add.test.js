...
let a = new TestComp();//duration = 10;
bil.insert.append(a,10); //

let b = new TestComp();//duration = 10 BUT start time = 15 when bil.len = 10;
expect(()=>{ bil.insert.add(b,15,10)}).toThrow();
});
...
//--Insert-2
let b = new TestComp();//daration = 10;
