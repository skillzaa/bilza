export default function h12bp(scene, hslColorNo = 240, titleContent = "", bp1Content = "", bp1EntryTime = 0, bp2Content = "", bp2EntryTime = 0, ftNoteContent = "", ftNoteEntryTime = 0, titleY = 5) {
    if (titleContent !== "") {
